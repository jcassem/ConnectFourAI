...
namespace ConnectFourGame
{
    class Program
    {
        ...
        {
            AbstractPlayer playerOne = new RandomPlayer(ConnectFourGame.PlayerOneGamePiece);
            AbstractPlayer playerTwo = new RandomPlayer(ConnectFourGame.PlayerTwoGamePiece);
